...
MONTH_ORDER = [
    ...
    "Ene26", "Feb26", "Marz26", "Abril26", "May26", "Jun26", "Jul26", "Agos26", "SEPT26"
]
...
def parse_employee_expenses(wb, sheet_name):
    ...
    for r_idx in range(1, sheet.max_row + 1):
        ...
        # Detectar si es una fila de total de ventas del turno
        ...
        is_cobro_row = is_total_tm or is_total_tt
        ...
        if is_cobro_row and total > 0:
            emp_name = "—"
            # Regla: si en col L hay un nombre de empleado válido, usarlo. Sino usar de asistencia del turno
...
def main():
    ...
    # 3. Generar la solapa exclusiva de auditoría de turnos para Septiembre, Agosto, Julio, Junio, Mayo, Abril y Marzo 2026
    cierre_septiembre_data = parse_cierre_auditoria(wb, "SEPT26")
...
const DATOS_SINCRONIZADOS = {{
  ...
  cierre_septiembre_2026: {json.dumps(cierre_septiembre_data)},
